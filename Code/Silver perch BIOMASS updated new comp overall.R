...
write_csv(yy, "Silver perch BIOMASS updated good prediction plot data overall.csv")
...
ggsave("Silver perch BIOMASS good prediction plot overall.pdf", width = 21, height=14.8, units="cm", dpi =600)
ggsave("Silver perch BIOMASS good prediction plot overall.png", width = 21, height=14.8, units="cm", dpi =600)