...
b2 <- brm(Golden ~ s(days_since) + # s(Month, bs="cc")+
          ...
          file_refit = "always",
          seed=1234567,
          file = paste0(taxa[j],"_newcomp_boat_MDB.rds")) # "../../srv/scratch/z3374139/MDB models/",
...
write_csv(yy, "Murray cod_updated good prediction plot data overall_boat method.csv")
...
ggsave("Murray cod_updated good prediction plot overall boat.pdf", width = 21, height=14.8, units="cm", dpi =600)
ggsave("Murray cod_updated good prediction plot overall boat.png", width = 21, height=14.8, units="cm", dpi =600)
