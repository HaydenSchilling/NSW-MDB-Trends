...
write_csv(yy, "Murray cod_updated good prediction plot data WRPA_boat method.csv")
...
ggsave("Murray cod_updated good prediction plot WRPA boat.pdf", width = 21, height=23, units="cm", dpi =600)
ggsave("Murray cod_updated good prediction plot WRPA boat.png", width = 21, height=23, units="cm", dpi =600)
