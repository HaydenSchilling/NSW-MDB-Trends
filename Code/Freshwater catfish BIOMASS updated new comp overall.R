...
write_csv(yy, "Freshwater catfish BIOMASS updated good prediction plot data overall.csv")
...
ggsave("Freshwater catfish BIOMASS good prediction plot overall.pdf", width = 21, height=14.8, units="cm", dpi =600)
ggsave("Freshwater catfish BIOMASS good prediction plot overall.png", width = 21, height=14.8, units="cm", dpi =600)