...
write_csv(yy, "Macquarie perch BIOMASS updated good prediction plot data WRPA.csv")
...
ggsave("Macquarie perch BIOMASS updated good prediction plot WRPA.pdf", width = 21, height=23, units="cm", dpi =600)
ggsave("Macquarie perch BIOMASS updated good prediction plot WRPA.png", width = 21, height=23, units="cm", dpi =600)
