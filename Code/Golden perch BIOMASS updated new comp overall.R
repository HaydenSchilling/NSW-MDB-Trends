...
b2 <- brm(Biomass ~  s(days_since) + # s(Month, bs="cc")+
          ...
          file_refit = "never",
          seed=123456,
          file = paste0(taxa[j],"_updated_BIOMASS_newcomp_boat_overall.rds")) # "../../srv/scratch/z3374139/MDB models/",
# 
# summary(b2)
...
model.check <- createDHARMa(
  ...
  observedResponse = mydata_wide$Biomass,
...
write_csv(yy, "Golden perch BIOMASS updated good prediction plot data overall.csv")
...
ggsave("Golden perch BIOMASS good prediction plot overall.pdf", width = 21, height=14.8, units="cm", dpi =600)
ggsave("Golden perch BIOMASS good prediction plot overall.png", width = 21, height=14.8, units="cm", dpi =600)