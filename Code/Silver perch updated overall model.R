...
b2 <- brm(Golden ~ s(days_since) + # s(Month, bs="cc")+
            (1|SiteID) + (1|fDate)+
...
write_csv(yy, "Silver_perch_updated good prediction plot data overall_boat method.csv")
...
ggsave("Silver_perch_updated good prediction plot overall boat.pdf", width = 21, height=14.8, units="cm", dpi =600)
ggsave("Silver_perch_updated good prediction plot overall boat.png", width = 21, height=14.8, units="cm", dpi =600)
