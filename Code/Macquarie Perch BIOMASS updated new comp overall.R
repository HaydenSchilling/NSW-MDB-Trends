...
### Add biomass weights
biom <- read_csv("Macquarie perch operation mean weights.csv") %>%
...
write_csv(yy, "Macquarie perch BIOMASS updated good prediction plot data overall.csv")
...
ggsave("Macquarie perch BIOMASS good prediction plot overall.pdf", width = 21, height=14.8, units="cm", dpi =600)
ggsave("Macquarie perch BIOMASS good prediction plot overall.png", width = 21, height=14.8, units="cm", dpi =600)