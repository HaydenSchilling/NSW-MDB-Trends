...
b2 <- brm(Golden ~ Method + s(days_since) +
          ...
          file_refit = "always",
          seed=1234567,
          file = paste0(taxa[j],"updated_newcomp_boat_overall.rds")) # "../../srv/scratch/z3374139/MDB models/",
...
write_csv(yy, "Macquarie perch updated good prediction plot data overall.csv")
...
ggsave("Macquarie perch updated good prediction plot overall.pdf", width = 21, height=23, units="cm", dpi =600)
ggsave("Macquarie perch updated good prediction plot overall.png", width = 21, height=23, units="cm", dpi =600)
