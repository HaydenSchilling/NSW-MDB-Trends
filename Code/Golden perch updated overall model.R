...
write_csv(yy, "Golden_perch_updated good prediction plot data overall_boat method.csv")
...
ggsave("Golden_perch_updated good prediction plot overall boat.pdf", width = 21, height=14.8, units="cm", dpi =600)
ggsave("Golden_perch_updated good prediction plot overall boat.png", width = 21, height=14.8, units="cm", dpi =600)
