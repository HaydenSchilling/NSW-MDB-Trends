...
write_csv(yy, "Murray cod BIOMASS updated good prediction plot data overall.csv")
...
ggsave("Murray cod BIOMASS good prediction plot overall.pdf", width = 21, height=14.8, units="cm", dpi =600)
ggsave("Murray cod BIOMASS good prediction plot overall.png", width = 21, height=14.8, units="cm", dpi =600)