...
write_csv(yy, "Common carp updated good prediction plot data overall.csv")
...
ggsave("Common carp updated good prediction plot  overall.pdf", width = 21, height=23, units="cm", dpi =600)
ggsave("Common carp updated good prediction plot overall.png", width = 21, height=23, units="cm", dpi =600)
