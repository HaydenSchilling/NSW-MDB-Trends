...
write_csv(yy, "Common carp updated good prediction plot data WRPA.csv")
...
ggsave("Common carp updated good prediction plot WRPA.pdf", width = 21, height=23, units="cm", dpi =600)
ggsave("Common carp updated good prediction plot WRPA.png", width = 21, height=23, units="cm", dpi =600)
