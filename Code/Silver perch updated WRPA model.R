...
b2 <- brm(Golden ~ SWWRPANAME_NEW + s(days_since, by = SWWRPANAME_NEW) + # s(Month, bs="cc")+
            (1|SiteID) + (1|fDate)+
          ...
          file_refit = "always",
          seed=1234567,
          file = paste0(taxa[j],"_updated_newcomp_boat_MDB.rds")) # "../../srv/scratch/z3374139/MDB models/",
...
write_csv(yy, "Silver_perch_updated good prediction plot data WRPA_boat method.csv")
...
ggsave("Silver_perch_updated good prediction plot WRPA boat.pdf", width = 21, height=14.8, units="cm", dpi =600)
ggsave("Silver_perch_updated good prediction plot WRPA boat.png", width = 21, height=14.8, units="cm", dpi =600)
