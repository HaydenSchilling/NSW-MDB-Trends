...
write_csv(yy, "Freshwater catfish updated good prediction plot data overall.csv")
...
ggsave("Freshwater catfish updated good prediction plot  overall.pdf", width = 21, height=23, units="cm", dpi =600)
ggsave("Freshwater catfish updated good prediction plot overall.png", width = 21, height=23, units="cm", dpi =600)
