...
b2 <- brm(Golden ~ Method + SWWRPANAME_NEW + s(days_since, by = SWWRPANAME_NEW) +
          ...
          file_refit = "never",
          seed=1234567,
          file = paste0(taxa[j],"_newcomp_boat_WRPA.rds")) # "../../srv/scratch/z3374139/MDB models/",
...
write_csv(yy, "Freshwater catfish updated good prediction plot data WRPA.csv")
...
ggsave("Freshwater catfish updated good prediction plot WRPA.pdf", width = 21, height=23, units="cm", dpi =600)
ggsave("Freshwater catfish updated good prediction plot WRPA.png", width = 21, height=23, units="cm", dpi =600)
